...
toast.add({ title: 'Yes, goed gedaan!!', description: 'Je hebt de module afgerond', color: 'success' })
}
...
<template>
    ...
    <UButton v-bind:loading-auto="true" label="Rond Module Af" @click="onClick()" class="mt-4">
  </UButton>
    </div>
    </div>
</template>